...
class Monitor():
    def __init__(self):
        ...
        self.cn_waiting = Value('i',0) #Número de coches en sentido norte dentro del puente.
        self.cs_waiting = Value('i',0) #Número de coches en sentido sur dentro del puente.
        self.ped_waiting = Value('i',0) #Número de peatones dentro del puente.
